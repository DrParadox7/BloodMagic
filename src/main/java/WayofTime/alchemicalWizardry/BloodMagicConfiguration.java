...
public class BloodMagicConfiguration {
    ...
    public static void syncConfig() {
        ...
        AlchemicalWizardry.lpPerHpBase = config
                .get("sacrifice", "LP gained per HP from sacrifice", AlchemicalWizardry.lpPerHpBase)
                .getInt(AlchemicalWizardry.lpPerHpBase);
